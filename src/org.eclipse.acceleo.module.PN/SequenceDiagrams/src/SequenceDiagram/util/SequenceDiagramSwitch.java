...
public class SequenceDiagramSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case SequenceDiagramPackage.SD: {
				SD sd = (SD)theEObject;
				T result = caseSD(sd);
			...
			case SequenceDiagramPackage.CALL: {
				Call call = (Call)theEObject;
				T result = caseCall(call);
				if (result == null) result = caseMessage(call);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SequenceDiagramPackage.CALL_ACK: {
				CallAck callAck = (CallAck)theEObject;
				T result = caseCallAck(callAck);
				if (result == null) result = caseMessage(callAck);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SequenceDiagramPackage.RETURN: {
				Return return_ = (Return)theEObject;
				T result = caseReturn(return_);
				if (result == null) result = caseMessage(return_);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SequenceDiagramPackage.OBJECT: {
				SequenceDiagram.Object object = (SequenceDiagram.Object)theEObject;
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Call Ack</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Call Ack</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseCallAck(CallAck object) {
		return null;
	}
	 ...
	 * @generated
	 */
	public T caseObject(SequenceDiagram.Object object) {
		return null;
	}
